...
class CashRegistersExport implements FromCollection, WithEvents, WithMapping, WithCustomStartCell
{
    ...
    public function registerEvents(): array
    {
        return [
            BeforeWriting::class => function (BeforeWriting $event) {
                ...
                $templateFile = new LocalTemporaryFile(storage_path('app/public/templates/xlsx/1_Reportes_Caja_Chica.xlsx'));
    ...
    private function HojaCajaChicaDetalle($sheet)
    {
        ...
        // $details = CashRegisterDetail::where('cash_register_id', $this->cash_register_id)->orderByRaw("issue_type, CASE WHEN issue_type = '89' THEN issue_number ELSE issue_date END")->get();
