...
return [
    ...
    */
    ...
    'title' => 'Sistema Integrado de Gestión Administrativa',
    'title_prefix' => '',
    'title_postfix' => '- SIGA SATP',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'images/logo_institution.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => '50%',
            'height' => '0%',
    ...
    */
    ...
    |
    | For detailed instructions you can look her
    e:
