...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_register_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('order_register_id');
            $table->foreign('order_register_id')->references('id')->on('order_registers');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('order_register_details');
    }
};
