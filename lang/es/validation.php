...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'taxable_basis' => 'base gravada',
        'igv' => 'igv',
        'untaxed_basis' => 'base no gravada',
        ...
        'total_honorary' => 'total honorario',
        'retention' => 'retención',
        'net_honorary' => 'neto recibido',
        'type_id' => 'tipo',
        'request_type' => 'tipo de solicitud',
        'reference_document' => 'documento de referencia',
        'purpose' => 'finalidad',
        'justification' => 'justificación',
        'requestFileClassifier' => 'clasificadores',
        'request_amount' => 'monto solicitado',
        'year' => 'año',
        'request_date' => 'fecha de solicitud',
        'destination' => 'destino',
        'means_of_transport' => 'medio de transporte',
        'number_days' => 'número de días',
        'departure_date' => 'fecha de salida',
        'return_date' => 'fecha de retorno',
        'opening_date' => 'fecha de apertura',
        'siaf_date' => 'fecha de siaf',
        'siaf_number' => 'número de siaf',
        'voucher_date' => 'fecha de voucher',
        'voucher_number' => 'número de voucher',
        'order_pay_electronic_date' => 'fecha de orden de pago electrónic',
        'settlement' => 'liquidación',
        'correlative_search' => 'correlativo',
        'year_search' => 'año',
        'closing_date' => 'fecha de cierre',
        'amount_to_pay' => 'monto a rendir',
        'surrender_report' => 'información de rendición',
