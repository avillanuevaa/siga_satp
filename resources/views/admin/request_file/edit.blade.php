  ...
  <div class="col-12 col-lg-10">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form id="registerForm" action="{{ route('requestFiles.update', $requestFile) }}" method="POST" >
          @csrf
          @method('patch')
          ...
          <div class="form-group row mt-4">
            <div class="col-lg-12 col-sm-4 col-xs-12 col-md-offset-2">
              @if( ($requestFile?->approval) !== 1)<button type="submit" class="btn btn-success">Guardar</button>@endif
