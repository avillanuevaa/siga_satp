...
@endphp
<x-adminlte-modal id="onCloseViaticRegister" title='Cerrar Viáticos'  static-backdrop>
  <form id="dataFormModalClose" name="dataFormModalClose">
    <x-adminlte-input type="hidden" name="viatic_register_id"  />
    <div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <fieldset class="border p-3 mb-3">
          <legend class="w-auto font-weight-bold text-md">Documento de Autorización</legend>
      ...
      <div class="col-md-6">
        <x-adminlte-input name="viatic_type" label="Tipo de Viático" placeholder="Tipo de Viático" readonly />
      </div>

      <div class="col-md-6">
        <x-adminlte-input name="destination" label="Destino" placeholder="Destino" readonly />
      </div>

      <div class="col-md-6">
        <x-adminlte-input name="means_of_transport" label="Medio de Transporte" placeholder="Medio de Transporte" readonly />
      </div>
      
      <div class="col-md-6">
        <x-adminlte-input name="format_number_two" label="Formato 02 N" placeholder="Formato 02 N" readonly />
      </div>

      <div class="col-md-6">
        <x-adminlte-input name="departure_date" label="Fecha de Salida" placeholder="Fecha de Salida" readonly />
      </div>

      <div class="col-md-6">
        <x-adminlte-input name="number_days" label="Número de días" placeholder="Número de días" readonly />
      </div>

      <div class="col-md-6">
        <x-adminlte-input name="return_date" label="Fecha de Retorno" placeholder="Fecha de Retorno" readonly />
      </div>
      ...
      <div class="col-md-6">
        <fieldset class="border p-3 mb-3">
          <legend class="w-auto font-weight-bold text-md">Expediente SIAF</legend>
          <div class="row justify-content-center">
            <div class="col-md-12">
      ...
      <div class="col-md-6">
        <fieldset class="border p-3 mb-3">
          <legend class="w-auto font-weight-bold text-md">Comprobante de Pago</legend>
          <div class="row justify-content-center">
            <div class="col-md-12">
...
$(document).ready(function() {
  ...
  $("#onSaveClose").click(function() {
    ...
    const viaticRegisterId = document.getElementById("viatic_register_id");
    ...
    const objData = {
      viatic_register_id: viaticRegisterId.value,
    ...
    fetch("{{ route('viaticRegisters.close') }}", {
      method: 'POST',
      headers: {
    ...
    .then(data => {
      if (data.success){
        ...
        window.location.href = "{{ session('previous_url_viatic_register') }}";
